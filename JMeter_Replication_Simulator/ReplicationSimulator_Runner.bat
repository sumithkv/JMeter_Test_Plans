...
call %JMETER_HOME%\bin\jmeter.bat -n -t "%JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\PerformanceTestPlan.jmx" -JJMeter_Home=%JMETER_HOME% -JTestDuration=%Duration% -JTestUsers=%NoUsers% -JLoopCount=-1 -l %JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\CMD_Output\JMeter_Test_Output.jtl -j %JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\CMD_Output\JMeter_Test_Log.log

@REM Generating JMeter Reports
echo Generating The JMeter Test Reports... Please Wait... ... ...
java -jar %JMETER_HOME%\lib\cmdrunner-2.0.jar  --tool Reporter --generate-csv %JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\CMD_Output\BOSS_AggregateReport.csv --input-jtl %JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\CMD_Output\JMeter_Test_Output.jtl --plugin-type AggregateReport
java -jar %JMETER_HOME%\lib\cmdrunner-2.0.jar  --tool Reporter --generate-csv %JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\CMD_Output\BOSS_TransactionsPerSecond.csv --input-jtl %JMETER_HOME%\JMeter_Test_Plans\JMeter_Replication_Simulator\CMD_Output\JMeter_Test_Output.jtl --plugin-type TransactionsPerSecond
